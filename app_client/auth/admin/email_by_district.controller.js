...
function emailByDistrictCtrl ($routeParams, $uibModal, authentication){
	var vm = this;
	vm.maxAttachmentCnt = 4;
	vm.checkTotal = 0;
	vm.header = {
		title: 'Send E-mail - by District'
	};
...
//							console.log(group._id + ": " + field.name + ', ' + field.email);
...
//			ariaDescribedBy: 'modal-body',
			...
			controller: 'emailByDistrictModalCtrl',
//			controllerAs: '$ctrl',
...
//					vm.maxAttachmentCnt = res;
	...
	function init(){
		return authentication.getStudentsByDistricts()
		.then(function(res){
			vm.districts = res;
			vm.counts = {
					"TK": 0,
...
function emailByDistrictModalCtrl($scope, $uibModalInstance, recipients, emails, maxCnt, sendEmail, authentication){
...
angular
	.module('jkcApp')
	.controller('emailByDistrictCtrl', emailByDistrictCtrl)
	.controller('emailByDistrictModalCtrl', emailByDistrictModalCtrl);
})();