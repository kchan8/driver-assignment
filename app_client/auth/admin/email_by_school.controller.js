...
function emailBySchoolCtrl ($routeParams, $uibModal, authentication){
	var vm = this;
...
//					vm.maxAttachmentCnt = res;
	...
	function init(){
		return authentication.getStudentsBySchools()
		.then(function(res){
			vm.schools = res;
			vm.counts = {
					"TK": 0,
...
function emailBySchoolModalCtrl($scope, $uibModalInstance, recipients, emails, maxCnt, sendEmail, authentication){
...
angular
	.module('jkcApp')
	.controller('emailBySchoolCtrl', emailBySchoolCtrl)
	.controller('emailBySchoolModalCtrl', emailBySchoolModalCtrl)
